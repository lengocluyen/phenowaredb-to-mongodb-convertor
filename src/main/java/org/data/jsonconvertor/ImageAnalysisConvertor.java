...
public class ImageAnalysisConvertor {
	public static List<LinkedHashMap<String, Object>> ImageAnalysisConvertToJson() {
		...
		for (ImgProcResult ipr : iprs) {
			...
			parallelBoudingBoxweight.put("value", ipr.getParallelboundingbox_width());
			...
			parallelBoudingBoxarea.put("value", ipr.getParallelboundingbox_area());
			...
			nonParallelBoudingBoxx.put("value", ipr.getNonparallelboundingbox_x());
			...
			nonParallelBoudingBoxy.put("value", ipr.getNonparallelboundingbox_y());
			...
			nonParallelBoudingBoxheight.put("value", ipr.getNonparallelboundingbox_height());
			...
			nonParallelBoudingBoxweight.put("value", ipr.getNonparallelboundingbox_width());
			...
			nonParallelBoudingBoxarea.put("value", ipr.getNonparallelboundingbox_area());
			...
			nonParallelBoudingBoxteta.put("value", ipr.getNonparallelboundingbox_teta());
			...
			nonParallelBoudingBox.put("height", nonParallelBoudingBoxheight);
			...
			minenclosingcirclearea.put("value", ipr.getMinenclosingcircle_area());
			...
			minenclosingcircleradius.put("value", ipr.getMinenclosingcircle_radius());
			...
			imageAnalysis.put("imageAnalysisProccessing", ipr.getImagProcProfile()==null?ipr.getImgprocprofilename():ipr.getImagProcProfile().getImgProcProfileId());
			imageAnalysis.put("imageAcquisitionDate", ipr.getAcquisitiondate());
			imageAnalysis.put("imageAnalysisDate", ipr.getResultdate());
			imageAnalysis.put("imageAnalysisTimestamp", ipr.getTimeStampResult());
	...
	public static void ExportToFile(String filename) {
		List<LinkedHashMap<String, Object>> jsons3 = ImageAnalysisConvertToJson();
	...
	public static void main(String[] args) {
		Date start = new Date();
		ExportToFile("Data/ImageAnalysis.json");
		Date end = new Date();
